...
Companion documents:
- **`03.FocusOS-v2-Admin-Panel.md`** — Phase 4.5: users, roles, quotas, runtime switches, audit log.
- **`02.FocusOS-v2-Focus-Design.md`** — the behavioural changes that decide whether this gets used in month three. Read it before picking what to build.
...
Users, roles, usage meters, runtime kill switches and an audit log. **No credential management** — Claude and Gemini keys stay in env vars, Ollama is a per-user frontend setting. Full spec in **`03.FocusOS-v2-Admin-Panel.md`**. Supersedes `OWNER_UIDS` with Firebase role claims.
...
/api/admin/**                    → see 03.FocusOS-v2-Admin-Panel.md §9
```
