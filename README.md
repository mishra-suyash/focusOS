...
FocusOS is being rebuilt in phases toward a much larger spec — see `plan/01.FocusOS-v2-Plan.md` (plus `plan/03.FocusOS-v2-Admin-Panel.md` and `plan/02.FocusOS-v2-Focus-Design.md`) for the full plan. **This README describes Phase 0 (Foundation and cuts) through Phase 6 (Goals, daily loop, alerts).** Still to come:
